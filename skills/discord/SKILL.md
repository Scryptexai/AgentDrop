---
name: discord
description: "Pintasan Telegram: delegasikan tugas ke pekerja-discord (aktivitas di server Discord proyek). Ketik /discord <tugas>."
version: 1.0.0
author: AgentDrop
license: MIT
...
# /discord — delegasikan ke `pekerja-discord`

Pintasan untuk **aktivitas di server Discord proyek**.

Teks setelah perintah adalah tugasnya. Delegasikan ke `pekerja-discord` lewat
